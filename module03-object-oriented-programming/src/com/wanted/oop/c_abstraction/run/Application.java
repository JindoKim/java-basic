...
public class Application {
    public static void main(String[] args) {
         ...
         * 객체를 설계 하기 위해서는 복잡한 현실세계를 그대로 반영하기에는 너무 방대하고 복잡하다.
         * 따라서, 현실세계를 프로그램의 목적에 맞게 단순화 하는 것을 추상화 라고 한다.
         * */
        ...
        * 3. 카레이서가 액셀을 밟으면 시동이 걸려있다면 시속이 10km/h 증가하며 앞으로 나간다.
        ...
        * */
        ...
        /* 은/는 , 이/가 <- 이 키워드 앞 단어가 대부분 클래스 후보이다.
