...
public class Application02 {
    public static void main(String[] args) {
        ...
        */
        ...
        bookList.add(new BookDTO(1, "홍길동전", "허균132" , 50000));
        bookList.add(new BookDTO(2, "홍길동", "허균500" , 40000));
        bookList.add(new BookDTO(3, "홍길", "허균111" , 30000));
        bookList.add(new BookDTO(4, "홍길동12", "12313허균" , 20000));
        ...
        // 가격 오름차순 정렬은 같이 해보았다. 그러면 이제 어떤 식으로 코드들이 상호작용 하는 지 혹인을 했으니
