...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("예외 발생 여부와 관계 없이 실행됨....0");
        }
        ...
        /* comment.
        *   예외 전파와 throws 키워드
        *   - throws 는 메서드 선언부에 작성한다.
        *   - 예외에 대한 처리를 호출차(coller) 에게 위임하는(떠넘기는) 키워드이다.
    ...
    public static void checkAge(int age) throws IllegalArgumentException {
        if (age < 0) {
            ...
            throw new IllegalArgumentException("나이는 음수일 수 없습니다."); //("") 하면 e.getMessage();
        }
